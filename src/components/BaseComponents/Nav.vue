    ...
    <div class="HeaderTitle w-full">
      ...
      <div v-show="isMenuVisible"
        ...
        <!-- <a href="/login" class="transition-all hover:bg-gray-300 cursor-pointer me-2 my-1">
          ...
          系統登入</a> -->
        <div v-if="locale == 'ch'" class="mx-1 my-2 py-4">
          <span @click="locale = 'ch'" class="hover:underline underline-offset-8 underline">中文</span>
          <span>/</span>
          <span @click="locale = 'en'" class="hover:underline underline-offset-8">English</span>
        </div>
        <div v-if="locale == 'en'" class="mx-1 my-2 py-4">
          <span @click="locale = 'ch'" class="hover:underline underline-offset-8">中文</span>
          <span>/</span>
          <span @click="locale = 'en'" class="hover:underline underline-offset-8 underline">English</span>
        </div>
      </div>
      <!--電腦選單內容 結束-->
      <!--手機選單內容 開始-->
